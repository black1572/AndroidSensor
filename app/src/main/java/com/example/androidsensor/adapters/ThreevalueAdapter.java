package com.example.androidsensor.adapters;
...
public class ThreevalueAdapter extends RecyclerView.Adapter<ThreevalueAdapter.MyViewHolder> {
    private Context context;
    private List<ThreeValue> mThreeValueList;

    public ThreevalueAdapter(Context context) {
    ...
    @NonNull
    @Override
    public ThreevalueAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.threevalues_item,parent,false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ThreevalueAdapter.MyViewHolder holder, int position) {
